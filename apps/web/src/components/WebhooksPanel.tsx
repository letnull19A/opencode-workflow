...
import type { ModuleAction, ModuleDomain, WireWebhookBinding, WireWorkflow } from "@/lib/types";
  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        ...
        <CardDescription>POST /hooks — ingress → workflow (binding.workflow || module)</CardDescription>
      </CardHeader>
                ...
                {hooks.map((hook) => (
                  ...
                  >
                    ...
                    <div className="mt-1.5 flex flex-wrap gap-1">
                      {hook.workflow && (
                        <span className="rounded-full bg-background px-1.5 py-0.5 text-[10px] ring-1 ring-border" title="workflow">
                          wf: {hook.workflow}
                        </span>
                      )}
                      {hook.action && (
