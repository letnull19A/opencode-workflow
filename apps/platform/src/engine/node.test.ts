...
import type { INodeContext, INodeSpec } from "@opencode-workflow/sdk";
...
function nodeOf<T>(graph: { nodes: ReadonlyMap<string, import("@opencode-workflow/sdk").INode<T>> }, id: string): import("@opencode-workflow/sdk").INode<T> {
